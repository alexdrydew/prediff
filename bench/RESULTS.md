...
> [!NOTE]
> This is the historical pre-`@pierre/diffs` baseline. Re-run
> `bun bench/compare.ts` for current renderer numbers; the migration's focused
> 10,000-line acceptance result is recorded in `ARCHITECTURE.md`.
